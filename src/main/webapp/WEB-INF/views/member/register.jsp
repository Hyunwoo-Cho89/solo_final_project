...
<div class="signup-form">
    <form action="${contextPath}/member/memberReg" method="post">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col-xs-6"><input type="text" class="form-control" name="familyName" placeholder="Family Name (성)" required="required"></div>
				<div class="col-xs-6"><input type="text" class="form-control" name="firstName" placeholder="First Name (이름)" required="required"></div>
			</div>        	
        </div>
        <div class="form-group">
